...
const StepOne: React.FC = () => {
  ...
  const handleNextStep = () => {
    // TODO: Implement navigation to step two
    console.log('Moving to next step', {
      selectedTicketType: selectedCard,
    ...
    >
      ...
      >
        ...
        <p
          ...
          `}
        >
          Join us for an unforgettable experience at CodeFest 25! Secure your
          spot now.
        </p>
        <p
          className={`
